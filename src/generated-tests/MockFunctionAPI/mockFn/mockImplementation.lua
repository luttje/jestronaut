...
package.preload['SomeClass'] = package.preload['SomeClass_js']
...
package.preload['SomeClass_test'] = package.preload['SomeClass_test_js']
...
local tests = {
	...
	(function()
		test("mockFn.mockImplementation 1", function()
			-- `.mockImplementation()` can also be used to mock class constructors:
			-- 
			local ____lualib = require('lualib_bundle')
			local __TS__Class = ____lualib.__TS__Class
	...
	(function()
		test("mockFn.mockImplementation 2", function()
